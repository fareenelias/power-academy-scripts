...
TICKER_MAP = {
    'SJW':  'HTO',   # H2O America (formerly SJW Group)
    'NEP':  'XIFR',  # XPLR Infrastructure (formerly NextEra Energy Partners LP)
}

def get_ticker(filename):
    m = re.search(r'(?:NYSE|NASDAQ|NasdaqGS|NasdaqCM|OTC)([A-Z0-9]+)_Report',
